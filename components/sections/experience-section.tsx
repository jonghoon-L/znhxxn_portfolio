...
const EXPERIENCES = [
  ...
  {
    id: 2,
    title: "입시 관리형 독서실 웹/관리자 플랫폼 'Roadmap'",
    ...
    achievements: [
      ...
      '실제 학원 비즈니스 프로세스를 반영한 온라인 상담 신청, 등록 예약 및 후기 작성 시스템 구축',
      'Solapi 기반의 알림 문자(SMS) 본인 인증 로직 구현을 통한 사용자 접근 간편성 극대화',
      '이스터에그 라우팅 설계를 활용한 관리자 페이지 은닉 및 보안성 확보'
    ]
  },
  {
    id: 3,
